...
int main()
{
	...
	bool complete[n];
	cout << "Enter The Arrival Time Of The Processess : ";
	for(int i = 0; i < n; i++)
		cin>>arrival[i];
    cout<<"======================================================================="<<endl;
	cout << "Enter The Burst Time Of The Processess : ";
	for(int i = 0; i < n; i++)
    {
		cin>>burst[i];
    ...
    cout<<endl;
    cout<<"======================================================================="<<endl;
	cout << " || Program Number || Arrival Time || Burst Time || Wait Time || Turn Around Time || ";
	cout<<endl;
	for(int i = 0; i < n; i++){
	...
	cout<<endl<<"Average Waiting Time : "<<(avgWait/n)<<endl<<"Average Turn Around Time : "<<(avgTT/n);
	return 0;
}